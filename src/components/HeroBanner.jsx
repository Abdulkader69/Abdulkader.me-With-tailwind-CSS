...
import animationData from "../../public/animation/developer-lottie-animation.json";
  ...
  render() {
    ...
    return (
      <div className="ak_hero_banner_wrap h-screen-flex">
        ...
        <svg className="shape" id="triangle1" width="25px" height="25px">
          <svg
        ...
        <svg className="shape" id="semiCircle1" width="25px" height="25px">
          <path
            fill="none"
            stroke="#CF4981"
            strokeWidth="3"
        ...
        <svg className="shape" id="triangle2" width="25px" height="25px">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="25.675"
            height="22.236"
        ...
        <svg className="shape" id="triangle3" width="25px" height="25px">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="25.675"
            height="22.236"
        ...
        <svg className="shape" id="semiCircle2" width="25px" height="25px">
          <path
            fill="none"
            stroke="#CF4981"
            strokeWidth="3"
